...
const CheckInvoicesContent = () => {
    ...
    const fetchInvoices = async () => {
        try {
            ...
            setIsLoading(true);
            const response = await fetch("http://localhost:8080/api/user/paidinvoices", {
                headers: {
            ...
            // Wyświetlamy tylko opłacone faktury
            const paidInvoices = data.content.filter((invoice: Invoice) => invoice.paid);
...
export default CheckInvoicesContent;
